...
4. When prompted, provide the path to your default model. Otherwise, we will use the default of merlinite.
...
5. When prompted, please choose a train profile. Train profiles are GPU specific profiles that enable accelerated training behavior. If you are on MacOS or a Linux machine without a dedicated GPU, please choose `No Profile (CPU-Only)` by hitting Enter.
